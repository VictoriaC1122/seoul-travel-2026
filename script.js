...
const data = {
  ...
  importantAlerts: [
    { title: { "zh-Hant": "2026/05/19 是星期二", en: "May 19, 2026 is a Tuesday", ko: "2026/05/19 는 화요일" }, desc: { "zh-Hant": "景福宮官方固定週二休館，所以這天先排北村、韓服和景福宮外圍拍照；若要進宮內，需要改到別天。", en: "Gyeongbokgung is officially closed every Tuesday, so this day is currently planned for Bukchon, the hanbok shoot, and exterior palace photos only. Move the palace interior visit to another day if needed.", ko: "경복궁은 공식적으로 매주 화요일 휴궁이라서 이날은 북촌, 한복 촬영, 경복궁 외부 촬영 기준으로 잡는 것이 안전합니다. 궁 내부 입장을 원하면 다른 날로 옮겨야 합니다." } },
  ...
  itinerary: [
    { day: { "zh-Hant": "第 1 天", en: "Day 1", ko: "1일차" }, date: "2026-05-15", plan: { "zh-Hant": "抵達首爾、飯店入住、弘大簡單吃", en: "Arrive in Seoul, check in, and keep the first night light", ko: "서울 도착 후 체크인, 첫날은 가볍게" }, location: { "zh-Hant": "仁川機場 → 弘大", en: "Incheon → Hongdae", ko: "인천공항 → 홍대" }, costKrw: 50000, transport: { "zh-Hant": "AREX / 機場巴士 / 計程車，先到飯店放行李", en: "AREX / airport bus / taxi, then drop bags at the hotel", ko: "AREX / 공항버스 / 택시로 이동 후 호텔 체크인" }, reminder: { "zh-Hant": "這天不要排景點，晚餐和超商補貨就好。", en: "Do not schedule heavy sightseeing on arrival day. Dinner and convenience-store stocking is enough.", ko: "첫날은 무리해서 일정 넣지 말고 저녁과 간단한 장보기 정도로 두는 편이 좋습니다." }, open: true },
    { day: { "zh-Hant": "第 2 天", en: "Day 2", ko: "2일차" }, date: "2026-05-16", plan: { "zh-Hant": "漢南洞 + Leeum + 咖啡散步", en: "Hannam-dong + Leeum + cafe walk", ko: "한남동 + 리움 + 카페 산책" }, location: { "zh-Hant": "漢江鎮 / 漢南洞", en: "Hangangjin / Hannam-dong", ko: "한강진 / 한남동" }, costKrw: 120000, transport: { "zh-Hant": "地鐵到漢江鎮站，這區坡多，適合慢慢走", en: "Take the subway to Hangangjin Station. The area is hilly, so keep the pace easy.", ko: "한강진역으로 이동. 언덕이 있는 동네라 천천히 걷는 일정이 잘 맞습니다." }, reminder: { "zh-Hant": "Leeum 官方寫明週一休館、採預約制，所以把漢南洞排在週六最穩。", en: "Leeum is officially closed on Mondays and uses reservations, so Saturday is the safest Hannam day.", ko: "리움은 공식적으로 월요일 휴관이고 예약제가 있어서 한남동은 토요일 배치가 가장 안정적입니다." }, open: true },
    { day: { "zh-Hant": "第 3 天", en: "Day 3", ko: "3일차" }, date: "2026-05-17", plan: { "zh-Hant": "狎鷗亭 + 江南 + COEX", en: "Apgujeong + Gangnam + COEX", ko: "압구정 + 강남 + 코엑스" }, location: { "zh-Hant": "狎鷗亭羅德奧 / 江南", en: "Apgujeong Rodeo / Gangnam", ko: "압구정로데오 / 강남" }, costKrw: 150000, transport: { "zh-Hant": "上午先去狎鷗亭羅德奧，下午再接 COEX / 星空圖書館", en: "Start in Apgujeong Rodeo in the morning, then move to COEX and Starfield Library later.", ko: "오전은 압구정로데오, 오후는 코엑스와 별마당도서관으로 이어가는 동선이 가장 편합니다." }, reminder: { "zh-Hant": "狎鷗亭週末中午後人會變多，早午餐建議提早。", en: "Apgujeong gets busier after noon on weekends, so brunch is better earlier.", ko: "압구정은 주말 점심 이후 더 붐비니 브런치는 일찍 가는 편이 좋습니다." } },
    { day: { "zh-Hant": "第 4 天", en: "Day 4", ko: "4일차" }, date: "2026-05-18", plan: { "zh-Hant": "要看的展 + 聖水洞", en: "Your exhibition + Seongsu", ko: "보고 싶은 전시 + 성수" }, location: { "zh-Hant": "聖水洞 / 首爾林", en: "Seongsu / Seoul Forest", ko: "성수 / 서울숲" }, costKrw: 130000, transport: { "zh-Hant": "展覽盡量排中午前後，前後接聖水逛店和咖啡最順", en: "Aim for the exhibition around midday, then wrap it with Seongsu shopping and cafes.", ko: "전시는 점심 전후로 넣고 앞뒤를 성수 편집숍과 카페로 잇는 동선이 가장 자연스럽습니다." }, reminder: { "zh-Hant": "把聖水排在週一，可以避開週末最滿的人潮；如果展不在聖水，再用地鐵銜接回來。", en: "Monday keeps Seongsu less crowded than the weekend. If the exhibition is elsewhere, return to Seongsu by subway after it.", ko: "성수를 월요일에 두면 주말 인파를 피하기 좋습니다. 전시장이 다른 구역이어도 전시 후 성수로 넘어오면 됩니다." } },
    { day: { "zh-Hant": "第 5 天", en: "Day 5", ko: "5일차" }, date: "2026-05-19", plan: { "zh-Hant": "北村 + 韓服拍攝 + 景福宮外圍拍照", en: "Bukchon + Hanbok shoot + Gyeongbokgung exterior photos", ko: "북촌 + 한복 촬영 + 경복궁 외부 촬영" }, location: { "zh-Hant": "安國 / 北村 / 光化門", en: "Anguk / Bukchon / Gwanghwamun", ko: "안국 / 북촌 / 광화문" }, costKrw: 980000, transport: { "zh-Hant": "13:00 前從飯店出發，先到北村附近，不要壓線", en: "Leave the hotel before 13:00 and get into the Bukchon area early.", ko: "13:00 전에 호텔에서 출발해서 북촌 근처에 먼저 도착하는 편이 안전합니다." }, reminder: { "zh-Hant": "2026/05/19 是星期二，景福宮宮內休館，所以今天先抓北村、韓服和景福宮外牆 / 光化門一帶。", en: "May 19, 2026 is a Tuesday, so Gyeongbokgung itself is closed. Plan this day around Bukchon, the hanbok shoot, and the palace exterior / Gwanghwamun area.", ko: "2026/05/19 는 화요일이라 경복궁 내부는 휴궁입니다. 이날은 북촌, 한복 촬영, 경복궁 외부와 광화문 주변 기준으로 잡는 것이 안전합니다." }, open: true },
    { day: { "zh-Hant": "第 6 天", en: "Day 6", ko: "6일차" }, date: "2026-05-20", plan: { "zh-Hant": "退房、弘大最後採買、前往機場", en: "Check out, do final Hongdae shopping, then head to the airport", ko: "체크아웃 후 홍대에서 마지막 쇼핑, 공항 이동" }, location: { "zh-Hant": "弘大 → 仁川機場", en: "Hongdae → Incheon", ko: "홍대 → 인천공항" }, costKrw: 70000, transport: { "zh-Hant": "退房後先把時間留給弘大附近，傍晚再往機場移動", en: "Keep the day near Hongdae after check-out, then move to the airport in the evening.", ko: "체크아웃 후에는 홍대 근처에서 시간을 보내고 저녁에 공항으로 이동하는 흐름이 가장 편합니다." }, reminder: { "zh-Hant": "回程 20:05 起飛，不要把最後一天排到離飯店太遠。", en: "The return flight leaves at 20:05, so do not plan anything far from the hotel on the last day.", ko: "귀국편이 20:05 출발이라 마지막 날은 숙소에서 너무 멀리 가지 않는 편이 좋습니다." } },
  ],
  checklistGroups: [
